        ...
        <CardContent className="prose prose-sm max-w-none">
          ...
          <section className="mb-8">
            ...
            <ul className="list-disc pl-6 mb-4 text-muted-foreground space-y-2">
              <li><strong>Session Management:</strong> Keep you logged in as you navigate</li>
              <li><strong>Security:</strong> Prevent unauthorized access and fraud</li>
              <li><strong>Form Data:</strong> Remember information you enter in forms</li>
            </ul>
            ...
            <ul className="list-disc pl-6 mb-4 text-muted-foreground space-y-2">
              <li><strong>User Preferences:</strong> Remember your selected theme, language, or display settings</li>
              <li><strong>Recipe Filters:</strong> Save your cuisine or dietary preferences</li>
              <li><strong>Comment Tracking:</strong> Track which recipes you've commented on</li>
            </ul>

            <h3 className="text-xl font-semibold mb-3">2.3 Analytics Cookies</h3>
            <p className="text-muted-foreground mb-4">
              These cookies help us understand how visitors interact with our website, allowing us to improve the service.
            </p>
            <ul className="list-disc pl-6 mb-4 text-muted-foreground space-y-2">
              ...
              <li><strong>User Behavior:</strong> Click patterns, navigation flows</li>
            </ul>

            <h3 className="text-xl font-semibold mb-3">2.4 Third-Party Cookies</h3>
            <p className="text-muted-foreground mb-4">
            ...
            <ul className="list-disc pl-6 mb-4 text-muted-foreground space-y-2">
              ...
              <li><strong>Instagram:</strong> If you connect your Instagram account</li>
          ...
          <section className="mb-8">
            ...
            <ul className="list-disc pl-6 mb-4 text-muted-foreground space-y-2">
              ...
              <li><strong>Like Tracking:</strong> Track which recipes and comments you've liked</li>
              <li><strong>AI Features:</strong> Remember your AI image selections</li>
              <li><strong>Performance:</strong> Optimize loading times and reduce server load</li>
              <li><strong>Security:</strong> Detect and prevent fraudulent activity</li>
              <li><strong>Analytics:</strong> Understand usage patterns to improve features</li>
            </ul>
          </section>
          ...
          <section className="mb-8">
            ...
            <ul className="list-disc pl-6 mb-4 text-muted-foreground space-y-2">
              <li><strong>Local Storage:</strong> Store larger amounts of data like recipe drafts</li>
              <li><strong>Session Storage:</strong> Temporary data cleared when you close your browser</li>
              <li><strong>IndexedDB:</strong> Store structured data for offline access</li>
            </ul>
          </section>
          ...
          <section className="mb-8">
            ...
            <ul className="list-disc pl-6 mb-4 text-muted-foreground space-y-2">
              <li><strong>Block All Cookies:</strong> Prevent all websites from setting cookies</li>
              ...
              <li><strong>Incognito/Private Mode:</strong> Browse without saving cookies</li>
            </ul>
            ...
            <ul className="list-disc pl-6 mb-4 text-muted-foreground space-y-2">
              ...
              <li><a href="https://support.apple.com/guide/safari/manage-cookies-sfri11471/mac" target="_blank" rel="noopener noreferrer" className="underline">Apple Safari</a></li>
            ...
            <h3 className="text-xl font-semibold mb-3">6.3 Impact of Blocking Cookies</h3>
            <p className="text-muted-foreground mb-4">
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-semibold mb-4">7. Third-Party Cookie Policies</h2>
            <p className="text-muted-foreground mb-4">
              Our third-party service providers have their own cookie policies:
            </p>
            <ul className="list-disc pl-6 mb-4 text-muted-foreground space-y-2">
              <li><a href="https://policies.google.com/technologies/cookies" target="_blank" rel="noopener noreferrer" className="underline">Google Cookies Policy</a></li>
              <li><a href="https://firebase.google.com/support/privacy" target="_blank" rel="noopener noreferrer" className="underline">Firebase Privacy & Security</a></li>
              <li><a href="https://www.facebook.com/policies/cookies/" target="_blank" rel="noopener noreferrer" className="underline">Meta (Instagram) Cookies Policy</a></li>
              <li><a href="https://vercel.com/docs/analytics/privacy-policy" target="_blank" rel="noopener noreferrer" className="underline">Vercel Analytics Privacy</a></li>
            </ul>
          </section>
          ...
          <section className="mb-8">
            ...
            <p className="text-muted-foreground mb-4">
              Some browsers offer "Do Not Track" (DNT) signals. Currently, there is no industry standard for responding to DNT signals. We may or may not honor DNT requests, depending on the browser and context.
            </p>
          </section>
